...
3. utils/validation.ts to store reusable field validations, simplified to just required validation (able to test by submitting form with empty role and company)
